...
public class QueenOfTheOceanWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(QueenOfTheOceanWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/QueenOfTheOcean/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/QueenOfTheOcean/InitOutcome.xml").getDocumentElement();
